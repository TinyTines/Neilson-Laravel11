...
<body>
    <div class="card">
        <div class="card-body">
            ...
            <p class="footer-text">Belum punya akun? <a href="<?php echo e(route('halaman.registrasi')); ?>">Daftar di sini</a></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\laragon\www\laravel(ORI)\laravel11\resources\views/login.blade.php ENDPATH**/ ?>